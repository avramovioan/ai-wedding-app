      ...
      <div className="absolute top-0 h-24 w-full overflow-hidden md:h-40">
        <button
          className="absolute -top-[15.5rem] -left-[6.5rem] h-72 w-72 cursor-pointer rounded-full
                        bg-[rgb(149,125,197)] md:-top-[25rem] 
        ...
        <div className="absolute -top-[8rem] -right-[2rem] h-36 w-36 animate-ping  rounded-full bg-[rgb(149,125,197)] md:-right-[4rem] md:-top-[11rem] md:h-[15rem] md:w-[15rem]"></div>
        <button
          className="absolute -top-[15.5rem] -right-[6.5rem] h-72 w-72 rounded-full bg-[rgb(149,125,197)] md:-top-[25rem] 
